...
public class audi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btndate=findViewById(R.id.btndate1);
        ...
        LinearLayout screenaudi=findViewById(R.id.screenaudi);
        ...
        validation.setOnClickListener(v->{
            for(int i=0;i<screenaudi.getChildCount();i++)
            {
                View child=new View(this);
                child=screenaudi.getChildAt(i);
        ...
        {
            Intent int3=new Intent(audi.this,MainActivity3.class);
        ...
        {
            Intent int4=new Intent(audi.this,MainActivity.class);
