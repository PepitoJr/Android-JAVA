...
public class bmw extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btndate=findViewById(R.id.btndate2);
        ...
        LinearLayout screenBmw=findViewById(R.id.screenbmw);
        ...
        validation.setOnClickListener(v->{
            for(int i=0;i<screenBmw.getChildCount();i++)
            {
                View child=new View(this);
                child=screenBmw.getChildAt(i);
        ...
        {
            Intent int3=new Intent(bmw.this,MainActivity3.class);
        ...
        {
            Intent int4=new Intent(bmw.this,MainActivity.class);
