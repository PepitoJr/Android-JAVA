...
public class honda extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btndate=findViewById(R.id.btndate3);
        ...
        LinearLayout screenhonda=findViewById(R.id.screenhonda);
        ...
        validation.setOnClickListener(v->{
            for(int i=0;i<screenhonda.getChildCount();i++)
            {
                View child=new View(this);
                child=screenhonda.getChildAt(i);
        ...
        {
            Intent int3=new Intent(honda.this,MainActivity3.class);
        ...
        {
            Intent int4=new Intent(honda.this,MainActivity.class);
