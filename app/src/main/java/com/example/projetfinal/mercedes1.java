...
public class mercedes1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_mercedes1);


        TextView affdate=findViewById(R.id.affdate);
        Button btndate=findViewById(R.id.btndate7);
        ...
        LinearLayout screenmercedes=findViewById(R.id.screenmercedes);
        ...
        validation.setOnClickListener(v->{
            for(int i=0;i<screenmercedes.getChildCount();i++)
            {
                View child=new View(this);
                child=screenmercedes.getChildAt(i);
        ...
        {
            Intent int3=new Intent(mercedes1.this,MainActivity3.class);
        ...
        {
            Intent int4=new Intent(mercedes1.this,MainActivity.class);
