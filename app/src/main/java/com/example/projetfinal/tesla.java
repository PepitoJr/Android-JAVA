...
public class tesla extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btndate=findViewById(R.id.btndate4);
        ...
        LinearLayout screenTesla=findViewById(R.id.screentesla);
        ...
        validation.setOnClickListener(v->{
            for(int i=0;i<screenTesla.getChildCount();i++)
            {
                View child=new View(this);
                child=screenTesla.getChildAt(i);
        ...
        {
            Intent int3=new Intent(tesla.this,MainActivity3.class);
        ...
        {
            Intent int4=new Intent(tesla.this,MainActivity.class);
