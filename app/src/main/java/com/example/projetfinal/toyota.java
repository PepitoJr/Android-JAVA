...
public class toyota extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btndate=findViewById(R.id.btndate5);
        ...
        LinearLayout screentoyota=findViewById(R.id.screentoyota);
        ...
        validation.setOnClickListener(v->{
            for(int i=0;i<screentoyota.getChildCount();i++)
            {
                View child=new View(this);
                child=screentoyota.getChildAt(i);
        ...
        {
            Intent int3=new Intent(toyota.this,MainActivity3.class);
        ...
        {
            Intent int4=new Intent(toyota.this,MainActivity.class);
